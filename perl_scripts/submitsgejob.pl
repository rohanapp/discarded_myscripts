...
my $gMaxPath = "/home/nappann/software/max1403/maxwell14.0/maxwell";
...
sub BatchSolveMaxwellProject
{
	...
	# qsub -b y -cwd -V -v ANSOFT_DEBUG_MODE=1,ANSOFT_DEBUG_LOG=$HOME/ansdebuglogs/ansdebug.log
	# -pe pename numslots
